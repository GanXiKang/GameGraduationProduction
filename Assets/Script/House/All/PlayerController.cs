...
public class PlayerController : MonoBehaviour
{
    ...
    {
        if (!CameraControl_House.isLookWorkbench && !UIController.isContentActive && !BedControl_Bedroom.isSleep && !BagControl_House.isBagActive && !GameControl.isOpeningStopMove && !TaskController.isTaskActive && !SettingControl.isSettingActive && !GetItemUIControl.isGetItemActice && !isNoMove)
        {
