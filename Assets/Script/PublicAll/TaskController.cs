...
public class TaskController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!UIController.isContentActive && !BagController.isBagActive && GameControl._day != 1 && !CameraController.isLookWorkbench && !BedControl.isSleep && !GameControl.isOpeningStopMove && !SettingControl.isSettingActive &&
